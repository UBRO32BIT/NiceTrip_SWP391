                                ...
                                <React.Fragment>
                                    ...
                                    <Modal open={open} onClose={() => setOpen(false)}>
                                        ...
                                        >
                                                        ...
                                                        <Grid key={index} xs={12} sm={6}>
                                                            ...
                                                            >
                                                                <Box sx={{
                                                                    ...
                                                                    <Typography sx={{
                                                                        backgroundColor: post.is_bookable ? '#AEEA00' : 'gray',
                                                                        fontSize: '10px',
                                                                        display: 'inline-block',
                                                                        padding: '3px 8px',
                                                                        borderRadius: '4px',
                                                                        color: post.is_bookable ? '' : '#fff'
                                                                    }}>
                                            ...
                                            <CardActions
                                                sx={{alignSelf: 'flex-end', pt: 2, gap: 2, justifyContent: 'flex-end'}}>
                                                <Button sx={{width: '40%'}} variant="solid" color="primary"
                                                        type='submit' onClick={handleButtonSubmit}>
                                                    Continue
                                                </Button>
                                            </CardActions>
                                ...
                                <Stack direction="column" spacing={4} sx={{width: 1, mt: 1}}>
                                    ...
                                    <FormControl sx={{display: 'inline-flex', gap: 1, width: 1}}>
                                        ...
                                        <FormControl sx={{display: 'none'}}>
                                            <Input type="hidden" name="myTimeshareId"
                                                   value={myPosts[selectedResortIndex]?._id}/>
