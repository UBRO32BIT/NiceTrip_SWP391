                    ...
                    return (<>
                        <Card sx={{ width: { xs: 1, md: 0.3 }, minWidth: '320px' }}>
                            <div>
                                ...
                                <Typography level="body-sm" sx={{ display: 'inline-flex', gap: 1 }}>Verified {post?.is_verified ? <VerifiedOutlinedIcon color='success' /> : <VerifiedOutlinedIcon color='success' />}</Typography>
